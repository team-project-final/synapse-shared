...
|:----:|------|-----------|------|
| **W1** | 05-12 ~ 05-15 | 인프라 + 서비스 골격 + 기본 CRUD | 금요일까지 `./gradlew build` 실패 |
| **W2** | 05-19 ~ 05-22 | SRS 복습 엔진, AI 골격, Graph + ES, Schema Registry | 핵심 API 3개 미만 동작 |
...
> **공휴일**: 5/25(월) 부처님오신날, 6/3(수) 지방선거 — W3·W4가 4영업일인 이유.
