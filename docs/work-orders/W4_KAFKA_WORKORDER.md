...
→ **분석·권고 완료**: [D-002_SCHEMA_FAMILY_DECISION.md](../designs/D-002_SCHEMA_FAMILY_DECISION.md). **권고 = Option 2(JSON CloudEvent 통일)**, 대안 Option 1(Confluent Avro 사수). **팀 비준 필요**(전 서비스 영향 + PRD Registry 기준 재정의). **모든 Kafka 구현의 선결.**
