...
| 서비스 앱 (staging) | 🟡 **5/7 Healthy** — engagement-svc·learning-card 태그 불일치 ImagePullBackOff ([gitops#191](https://github.com/team-project-final/synapse-gitops/issues/191)) | 아래 §5 |
