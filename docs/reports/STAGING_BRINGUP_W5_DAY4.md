...
| 6 | **EKS staging window 비용 관리·teardown 정책 합의** ([gitops#183](https://github.com/team-project-final/synapse-gitops/issues/183)) — 현재 가동(4×t3.large+MSK+RDS×2+NAT) 중, 앱 0트래픽이라 owner 이미지 전까지 유지 vs `--destroy` 결정 | gitops/team-lead |
