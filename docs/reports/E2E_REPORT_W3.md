...
| I-1b | cards-generated HTTP 대체 → **D-001 확정**(매트릭스 정정). AI카드 알림 = 알림 버스 재사용 **설계 완료**(NOTIFICATION_TRIGGER_AI_CARDS), 구현/스키마공유 W4 | learning-ai/platform | P1 | @team-lead/owner | ✅ |
